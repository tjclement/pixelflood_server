...
func main() {
	screen_width := uint16(*flag.Int("screen_width", 320, "Width of the screen to draw on"))
	screen_height := uint16(*flag.Int("screen_height", 320, "Height of the screen to draw on"))
